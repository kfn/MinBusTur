...
public class JourneyDetailNoteMetaData
{
	...
	public static final String TABLE_NAME = JourneyDetailNoteMetaData.COLLECTION_TYPE;

	private JourneyDetailNoteMetaData()
	{
	}
