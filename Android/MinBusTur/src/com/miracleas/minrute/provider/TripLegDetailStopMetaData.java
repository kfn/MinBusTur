...
public class TripLegDetailStopMetaData
{
	...
	public static final String TABLE_NAME = TripLegDetailStopMetaData.COLLECTION_TYPE;

	private TripLegDetailStopMetaData()
	{
	}
