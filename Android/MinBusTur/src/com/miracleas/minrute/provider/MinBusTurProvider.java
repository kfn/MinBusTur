...
public class MinBusTurProvider extends ContentProvider
{
    ...
    private static final int INCOMING_SAVED_TRIP_COLLECTION_URI_INDICATOR = 28;
    private static final int INCOMING_SINGLE_SAVED_TRIP_URI_INDICATOR = 29;
    ...
    static
    {
        ...
        sUriMatcher.addURI(DirectionMetaData.AUTHORITY, DirectionMetaData.COLLECTION_TYPE, INCOMING_DIRECTION_COLLECTION_URI_INDICATOR);

        sUriMatcher.addURI(SavedTripMetaData.AUTHORITY, SavedTripMetaData.COLLECTION_TYPE, INCOMING_SAVED_TRIP_COLLECTION_URI_INDICATOR);
        sUriMatcher.addURI(SavedTripMetaData.AUTHORITY, SavedTripMetaData.COLLECTION_TYPE + "/#", INCOMING_SINGLE_SAVED_TRIP_URI_INDICATOR);
    }
    ...
    protected static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        public void onCreate(SQLiteDatabase db)
        {
            ...
            db.execSQL("CREATE TABLE IF NOT EXISTS " + DirectionMetaData.TABLE_NAME + getTableSchemaStart() + DirectionMetaData.getTableSchema() + getTableSchemaEnd());
            db.execSQL("CREATE TABLE IF NOT EXISTS " + SavedTripMetaData.TABLE_NAME + getTableSchemaStart() + SavedTripMetaData.getTableSchema() + getTableSchemaEnd());
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
        {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + DirectionMetaData.TABLE_NAME);
            db.execSQL("DROP TABLE IF EXISTS " + SavedTripMetaData.TABLE_NAME);
            onCreate(db);
        }
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
    {
        ...
        switch (sUriMatcher.match(uri))
        {
            ...
            case INCOMING_DIRECTION_COLLECTION_URI_INDICATOR:
                qb.setTables(DirectionMetaData.TABLE_NAME);
                break;
            case INCOMING_SAVED_TRIP_COLLECTION_URI_INDICATOR:
                qb.setTables(SavedTripMetaData.TABLE_NAME);
                break;

            case INCOMING_SINGLE_SAVED_TRIP_URI_INDICATOR:
                qb.setTables(SavedTripMetaData.TABLE_NAME);
                qb.appendWhere(SavedTripMetaData.TableMetaData._ID + "=" + uri.getPathSegments().get(1));
                break;
            default:
    ...
    public Uri insert(Uri uri, ContentValues initialValues)
    {
        ...
        {
            tbl = DirectionMetaData.TABLE_NAME;
            contentUri = DirectionMetaData.TableMetaData.CONTENT_URI;
        }
        else if (sUriMatcher.match(uri) == INCOMING_SAVED_TRIP_COLLECTION_URI_INDICATOR)
        {
            tbl = SavedTripMetaData.TABLE_NAME;
            contentUri = SavedTripMetaData.TableMetaData.CONTENT_URI;
        }
        else
        {
            throw new IllegalArgumentException("Unknown URI " + uri);
    ...
    public int delete(Uri uri, String where, String[] whereArgs)
    {
        ...
        switch (sUriMatcher.match(uri))
        {
            ...
            case INCOMING_SINGLE_GEOFENCE_URI_INDICATOR:
                ...
                break;
            case INCOMING_DIRECTION_COLLECTION_URI_INDICATOR:
                count = db.delete(DirectionMetaData.TABLE_NAME, where, whereArgs);
                break;
            case INCOMING_SINGLE_SAVED_TRIP_URI_INDICATOR:
                String rowId8 = uri.getPathSegments().get(1);
                count = db.delete(SavedTripMetaData.TABLE_NAME, SavedTripMetaData.TableMetaData._ID + "=" + rowId8 + (!TextUtils.isEmpty(where) ? " AND (" + where + ')' : ""), whereArgs);
                break;
            case INCOMING_SAVED_TRIP_COLLECTION_URI_INDICATOR:
                count = db.delete(SavedTripMetaData.TABLE_NAME, where, whereArgs);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI " + uri);
        }
    ...
    public int update(Uri uri, ContentValues values, String where, String[] whereArgs)
    {
        ...
        switch (sUriMatcher.match(uri))
        {
            ...
            case INCOMING_SINGLE_GEOFENCE_URI_INDICATOR:
                ...
                break;
            case INCOMING_DIRECTION_COLLECTION_URI_INDICATOR:
                count = db.update(DirectionMetaData.TABLE_NAME, values, where, whereArgs);
                break;
            case INCOMING_SINGLE_SAVED_TRIP_URI_INDICATOR:
                String rowId9 = uri.getPathSegments().get(1);
                count = db.update(SavedTripMetaData.TABLE_NAME, values, SavedTripMetaData.TableMetaData._ID + "=" + rowId9 + (!TextUtils.isEmpty(where) ? " AND (" + where + ')' : ""), whereArgs);
                break;
            case INCOMING_SAVED_TRIP_COLLECTION_URI_INDICATOR:
                count = db.update(SavedTripMetaData.TABLE_NAME, values, where, whereArgs);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI " + uri);
        }
