...
public class TripStopDetailsImageActivity extends SherlockFragmentActivity implements OnClickListener, ImageDownloaderActivity , LoaderCallbacks<Cursor>{
	...
	public void onLoadFinished(Loader<Cursor> loader, Cursor cursor)
	{
		if(loader.getId()==LOAD_TOILET_IMAGES && cursor.moveToFirst())
		{
			...
			int i = 0;
			do{
				images[i] = cursor.getString(iUrl);
				i++;
