...
public class TripStopDetailsImageFragment extends SherlockFragment {
    ...
    private IImageDownloader mImageDownloader = null;
	...
	public void onAttach(Activity activity)
	{
		...
		ImageDownloaderActivity imageDownloaderActivity = (ImageDownloaderActivity)activity;
		mImageDownloader = imageDownloaderActivity.getIImageDownloader();
	}
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mImageDownloader!=null) {
            mImageDownloader.download(mImageUrl, mImageView);
        }
    ...
    public void onDestroy() {
        ...
        if (mImageView != null) {
        	...
        	mImageDownloader.cancelMyWork(mImageView);
