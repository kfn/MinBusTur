...
public class JourneyDetailStopDeparturesMetaData
{
	...
	public static final String TABLE_NAME = JourneyDetailStopDeparturesMetaData.COLLECTION_TYPE;

	private JourneyDetailStopDeparturesMetaData()
	{
	}
