...
public class ImageCache
{
	 ...
	 * @throws Exception
	 */
	public ImageCache(Context context, String uniqueName) throws Exception
	{
		...
		synchronized (mDiskCacheLock)
		{
			...
			if (mDiskLruCache != null)
			{
				...
				try
				{
					...
					{
						Log.d(TAG, "not cached on disk: " + data);
					}
				}
				catch (final IOException e)
				{
	...
	{
		public int memCacheSize = IImageDownloader.DEFAULT_MEM_CACHE_SIZE;
		public int diskCacheSize = IImageDownloader.DEFAULT_DISK_CACHE_SIZE;
		...
		public ImageCacheParams(Context context, String uniqueName) throws Exception
		{
