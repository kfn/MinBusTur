 ...
 * image.
 */
public abstract class ImageWorker implements IImageDownloader
{
	...
	private int mPlaceHolderRessource = -1;
	 ...
	 */
	public boolean download(String data, ImageView imageView)
	{
		...
		if (bitmap != null)
		{
			...
			cached = true;
			// Log.d(data, "img cached");
		}
		else if (cancelPotentialWork(data, imageView))
		{
			// Log.d(data, "img not cached");
	...
	{
		mPlaceHolderRessource = resId;
		mLoadingBitmap = BitmapFactory.decodeResource(mResources, resId);
	}

	public int getPlaceHolderRessource()
	{
		return mPlaceHolderRessource;
	}
